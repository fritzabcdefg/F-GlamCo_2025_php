    ...
    <ul class="navbar-nav d-flex align-items-center gap-3">
      ...
      <?php else: ?>
        ...
        <?php if (isset($_SESSION['role']) && $_SESSION['role'] === 'admin'): ?>
          <!-- Admin-only links -->
          <li class="nav-item"><a class="nav-link text-pink" href="/F&LGlamCo/product/index.php">Items</a></li>
          <li class="nav-item"><a class="nav-link text-pink" href="/F&LGlamCo/admin/users.php">Users</a></li>
          <li class="nav-item"><a class="nav-link text-pink" href="/F&LGlamCo/admin/orders.php">Orders</a></li>
        <?php endif; ?>
